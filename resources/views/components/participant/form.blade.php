<div class="w-full max-w-full mt-16">
    <form class="rounded px-8 pt-6 pb-8 mb-4" method="post" action="{{ $event->path() . "/attendees/store" }}">
      ...
      <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring @error('name') border-red-500 @enderror" id="participantName" type="text" placeholder="Nama" name="name" autofocus>
          @error('name')
      ...
      <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring @error('email') border-red-500 @enderror" id="participantEmail" type="text" placeholder="Email" name="email">
            @error('email')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
            @enderror
      </div>

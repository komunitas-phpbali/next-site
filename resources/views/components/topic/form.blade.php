<div class="w-full md:w-1/2 mt-16 m-auto">
    <form class="rounded px-8 pt-6 pb-8 mb-4" method="post" action="{{ $action }}">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring @error('title') border-red-500 @enderror" id="topicName"
        ...
        <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring @error('desc') border-red-500 @enderror"
        ...
        <div class="mb-6">
            ...
            <select class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:ring @error('speakers') border-red-500 @enderror" multiple id="topicSpeaker" name="speakers[]">
